# 来自 https://github.com/austinbyers/esprima-ast-visitor
...
# 20251028 - new Expression and Elements ... etc 

class ArrowFunctionExpression(Node):
    @property
    def fields(self): return ['params','body']
...
class TemplateElement(Node):
    @property
    def fields(self): return ['value']

# es2025

class ImportDeclaration(Node):
    @property
    def fields(self): return ['attributes']
...
class ImportAttribute(Node):
    @property
    def fields(self): return ['key', 'value']

class ImportExpression(Node):
    @property
    def fields(self): return ['options']